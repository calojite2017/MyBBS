...
<article>
    <div class="company-detail__all">
        <div class="company-detail">
            <h1>お問い合わせ</h1>
            <div class="company-detail__contact__title">
                <h2><span>MY BBS</span>は掲示板のプロであることを自負しております。</h2>
                <h2>ぜひ、お気軽にお問い合わせください。</h2>
            </div>
            {{-- フォームの送り先↓↓ --}}
            <form action="{{ route() }}" method="POST" class="contact-detail__form" id="form1">
                @csrf
                <div class="form-kinds">
                    <p>お問い合わせ項目</p>
                    <div class="radio">
                        <input type="radio" id="return" name="formkinds" value="書籍の返品">
                        <label for="return">ウェブサイトについて</label>
                    </div class="radio">
                    <div class="radio">
                        <input type="radio" id="request" name="formkinds" value="当店への要望">
                        <label for="request">掲示板への要望</label>
                    </div>
                    <div class="radio">
